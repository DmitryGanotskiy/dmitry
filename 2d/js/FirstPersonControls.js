...
class FirstPersonControls {
	...
	constructor( object, domElement ) {
		...
		this.constrainVertical = true; // Ensure vertical constraint is enabled
		this.verticalMin = Math.PI/2.5; // Limit vertical rotation to -60 degrees
		this.verticalMax = Math.PI/1.5;  // Limit vertical rotation to +60 degrees
